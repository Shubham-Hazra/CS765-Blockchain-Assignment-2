# Class for block
class Block:
    def __init__(self,block_id,creator_id, previous_block_id,created_at, transactions,balances,length=0):
    ...
    def get_size(self): # Function to get the size of the block in Mbs
        return (1 + len(self.transactions)) * 0.008 # Assuming that each transaction is 1KB and the coinbase is 1KB (Included in the transactions list)            
...
if __name__ == '__main__':
    ...
    b1.print_block()
    b2 = Block(1, 2, 2, [100,100],["Txn_3", "Txn_4"],[2],3)
    b2.print_block()
